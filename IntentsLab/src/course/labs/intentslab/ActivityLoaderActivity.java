...
public class ActivityLoaderActivity extends Activity {
	...
	static public final String GET_TEXT = "Intent_Text";
	...
	private void startImplicitActivation() {
		...
		Intent base = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.google.com"));
		...
		Intent chooserIntent = Intent.createChooser(base, GET_TEXT);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			mUserTextView.setText(data.getStringExtra(GET_TEXT));
		}
